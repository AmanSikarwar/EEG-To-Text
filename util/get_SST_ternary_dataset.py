...
def get_SST_dataset(SST_dir_path, ZuCo_used_sentences, ZUCO_SENTIMENT_LABELS):
    ...
    def get_sentence_label_dict(
        SST_sentences_file_path, SST_labels_file_path, SST_dictionary_file_path
    ):
        """
    ...
    sentence_2_label_all, sentence_2_label_ternary = get_sentence_label_dict(
        SST_sentences_file_path, SST_labels_file_path, SST_dictionary_file_path
    )
...
if __name__ == "__main__":
    ...
    ZUCO_SENTIMENT_LABELS = json.load(
        open("./dataset/ZuCo/task1-SR/sentiment_labels/sentiment_labels.json")
    )
